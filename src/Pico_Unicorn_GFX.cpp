...
//namespace pimoroni {
  ...
  PicoUnicorn::PicoUnicorn(): Adafruit_GFX(16,7) {
    // Constructor to bind to Adafruit library
  };
...
void PicoUnicorn::from_hsv(float h, float s, float v, uint8_t &r, uint8_t &g, uint8_t &b) {
